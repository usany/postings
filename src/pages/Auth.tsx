...
function Auth({ newAccount, setNewAccount, setValue }) {
  ...
  return (  
    <div className='p-5'>
      ...
      <Button variant='outlined' onClick={supaOnSocialClick}>BASE 구글로 로그인</Button>
      ...
      <div className='p-10'>
        <SignUpDialogs move={newAccount.account} handleClose={toggleAccount}/>
      </div>
      <Motions />
    </div>
  )
